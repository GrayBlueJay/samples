...
using MassTransit;
using Serilog;
using TestSagaStateMachine.Consumers;
using TestSagaStateMachine.Models;
using TestSagaStateMachine.StateMachines;
...
IHost host = Host.CreateDefaultBuilder(args)
    ...
    .ConfigureServices((hostContext, services) =>
    {
        ...
        services.AddMassTransit(x =>
        {
            ...
            x.AddSagaStateMachine<BatchStateStateMachine, BatchState>()
                .InMemoryRepository();
